...
public class SpriteQualiltyPropDataTemplate extends TemplateObject
{
	...
	public void onLoadFinished()
	{
		...
		propData.baseValue = hpBase;
		propData.rate = hpRate;
		propData.spritePropType = SpritePropType.HP;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = apBase;
		propData.rate = apRate;
		propData.spritePropType = SpritePropType.AP;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = this.pdBase;
		propData.rate = pdRate;
		propData.spritePropType = SpritePropType.PD;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = mdBase;
		propData.rate = mdRate;
		propData.spritePropType = SpritePropType.MD;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = dodgeBase;
		propData.rate = 0;
		propData.spritePropType = SpritePropType.DODGE;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = crhBase;
		propData.rate = 0;
		propData.spritePropType = SpritePropType.CRH;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
		
		propData = new SpriteQualityPropData();
		propData.baseValue = healBase;
		propData.rate = 0;
		propData.spritePropType = SpritePropType.HEAL;
		propData.spriteQualityType = SpriteQualityType.values()[quality];
		spriteDataObject.propDataList.add(propData);
	}
