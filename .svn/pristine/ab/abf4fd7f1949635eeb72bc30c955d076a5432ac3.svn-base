...
class PNpc : public ::google::protobuf::Message {
 public:
  ...
  static const int kSkillIdListFieldNumber = 6;
  ...
  static const int kSpriteIdFieldNumber = 10;
...
// required bool selected = 5;
inline bool PNpc::has_selected() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void PNpc::set_has_selected() {
  _has_bits_[0] |= 0x00000010u;
}
inline void PNpc::clear_has_selected() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void PNpc::clear_selected() {
  selected_ = false;
  clear_has_selected();
}
inline bool PNpc::selected() const {
  return selected_;
}
inline void PNpc::set_selected(bool value) {
  set_has_selected();
  selected_ = value;
}
