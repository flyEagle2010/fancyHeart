				...
				if (file.exists() && file.isDirectory())
				{
					...
					for (File f : fileArray)
					{
						...
						if(f.isDirectory() && checkSub){
							String[] inner = scanNamespaceFiles(namespace+"."+tmpItemName, fileext, isReturnCanonicalPath,checkSub);
							if(inner == null){
								continue;
							}
							for(String i : inner){
...
//		}
//		System.out.println("**********************");
//		files = scanNamespaceFiles("com.doteyplay.game.action.activity", ".class");
//		for (int i = 0; files != null && i < files.length; i++)
//		{
//			System.out.println(files[i]);
//		}
