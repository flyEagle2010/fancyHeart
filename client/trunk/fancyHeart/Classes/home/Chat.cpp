...
{
    RichItemImage* reImg=RichItemImage::create(channel, Color3B::BLACK, 255, "CloseNormal.png");
    RichItemText* re1 = RichItemText::create(channel, Color3B::YELLOW, 255, chatMsg, "Helvetica", 24);
    richText->insertElement(reImg);
    richText->insertElement(re1);
